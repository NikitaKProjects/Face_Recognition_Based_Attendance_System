...
class Login_window:
    def __init__(self,root):
        ...
        img1 = img1.resize((1280,700), Image.Resampling.LANCZOS)
        ...
        img4=img4.resize((20,20),Image.Resampling.LANCZOS)
...
class Register:
    def __init__(self,root):
        ...
        img2 = img2.resize((370,500), Image.Resampling.LANCZOS)
        self.photoImg2 = ImageTk.PhotoImage(img2)  
        ...
        immg.resize((200,40),Image.Resampling.LANCZOS)
        ...
        imglg=imglg.resize((150,38),Image.Resampling.LANCZOS)
