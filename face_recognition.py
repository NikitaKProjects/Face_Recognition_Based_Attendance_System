...
class Face_recognition:
    def __init__(self,root):
        ...
        img_top=img_top.resize((630,640),Image.Resampling.LANCZOS)
        ...
        img_top2=img_top2.resize((640,640),Image.Resampling.LANCZOS)
    ...
    def face_recog(self):
        def draw_boundary(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in features:
                ...
                conn=mysql.connector.connect(host="localhost",username="root",password="root123",database="face_recognizer")
